					...
					<table cellspacing="0" cellpadding="1" rules="all"
						...
						<c:forEach items="${categoryList }" var="category" varStatus="vs">
							<tr onmouseover="this.style.backgroundColor = 'white'" onmouseout="this.style.backgroundColor = '#F5FAFE';">
								...
								<td style="CURSOR: hand; HEIGHT: 22px" align="center" width="17%">${category.name }</td>
								<td align="center" style="HEIGHT: 22px"><a id="edit" href="${ pageContext.request.contextPath }/admin/category/edit.jsp?cid=${category.cid }&name=${category.name}">
										<img src="${pageContext.request.contextPath}/images/i_edit.gif" border="0" style="CURSOR: hand">
									</a></td>

								<td align="center" style="HEIGHT: 22px"><a id="del" href="javascript:void(0)" onclick="delCategory('${category.cid}')">
