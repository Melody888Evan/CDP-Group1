...
-- Records of menu
-- ----------------------------
INSERT INTO `menu` VALUES ('1', 'stir-fried cabbage', 2.00, 'menu/白菜.jpg', '2018-08-16', 1, '白菜', '1');
INSERT INTO `menu` VALUES ('10', 'saute diced chicken with peanuts', 6.00, 'menu/宫爆鸡丁.jpg', '2018-08-30', 0, '宫爆鸡丁', '1');
INSERT INTO `menu` VALUES ('11', 'fruit and vegetable salad', 4.00, 'menu/果蔬沙拉.jpg', '2018-08-06', 1, '果蔬沙拉', '5');
INSERT INTO `menu` VALUES ('12', 'seaweed ribs and white gourd soup', 10.00, 'menu/海带排骨冬瓜汤.jpg', '2018-08-05', 0, '海带排骨冬瓜汤', '6');
INSERT INTO `menu` VALUES ('13', 'pepper steak', 9.00, 'menu/黑椒牛扒.jpg', '2018-08-12', 1, '黑椒牛扒', '1');
INSERT INTO `menu` VALUES ('14', 'red bull ', 2.00, 'menu/红牛.jpg', '2018-09-09', 0, '红牛', '4');
INSERT INTO `menu` VALUES ('15', 'braised meatball', 3.50, 'menu/红烧丸子饭.jpg', '2018-08-01', 0, '红烧丸子饭', '2');
INSERT INTO `menu` VALUES ('16', 'carved drunk chicken roll', 3.50, 'menu/花雕醉鸡卷.jpg', '2018-08-28', 0, '花雕醉鸡卷', '5');
INSERT INTO `menu` VALUES ('17', 'plain stir-fried noodles', 3.00, 'menu/家常素炒面.jpg', '2018-08-02', 1, '家常素炒面', '3');
INSERT INTO `menu` VALUES ('18', 'fried egg', 1.00, 'menu/煎鸡蛋.jpg', '2018-08-09', 0, '煎鸡蛋', '5');
INSERT INTO `menu` VALUES ('19', 'set with grilled chicken', 3.00, 'menu/烤鸡排套餐.jpg', '2018-08-24', 1, '烤鸡排套餐', '2');
INSERT INTO `menu` VALUES ('2', 'noodles served with soy sauce', 3.00, 'menu/拌面.jpg', '2018-08-27', 0, '拌面', '3');
INSERT INTO `menu` VALUES ('20', 'cola', 1.50, 'menu/可乐.jpg', '2018-08-14', 0, '可乐', '4');
INSERT INTO `menu` VALUES ('21', 'chicken set meal', 3.50, 'menu/口水鸡套餐.jpg', '2018-08-22', 1, '口水鸡套餐', '2');
INSERT INTO `menu` VALUES ('22', 'slow cooker soup', 5.00, 'menu/老火靓汤.jpg', '2018-08-21', 0, '老火靓汤', '6');
INSERT INTO `menu` VALUES ('23', 'brine double set meal', 5.00, 'menu/卤水双拼套餐.jpg', '2018-08-31', 1, '卤水双拼套餐', '2');
INSERT INTO `menu` VALUES ('24', 'Mapo beancurd ', 5.00, 'menu/麻婆豆腐.jpg', '2018-08-17', 0, '麻婆豆腐', '1');
INSERT INTO `menu` VALUES ('25', 'delicious roast pork', 6.00, 'menu/美味叉烧.jpg', '2018-08-13', 1, '美味叉烧', '1');
INSERT INTO `menu` VALUES ('26', 'delicious chicken wings', 4.00, 'menu/美味鸡翅.jpg', '2018-08-04', 0, '美味鸡翅', '1');
INSERT INTO `menu` VALUES ('27', 'rice', 1.50, 'menu/米饭.jpg', '2018-08-26', 1, '米饭', '5');
INSERT INTO `menu` VALUES ('28', 'secret sirloin combo', 3.00, 'menu/秘制牛腩营养套餐.jpg', '2018-08-25', 0, '秘制牛腩营养套餐', '2');
INSERT INTO `menu` VALUES ('29', 'chicken skewers with honey sauce', 4.00, 'menu/蜜汁鸡肉串.jpg', '2018-08-10', 1, '蜜汁鸡肉串', '5');
...
INSERT INTO `menu` VALUES ('32', 'lemon spice and big chicken steak', 2.50, 'menu/柠香手抓大鸡排.jpg', '2018-08-20', 0, '柠香手抓大鸡排', '5');
...
INSERT INTO `menu` VALUES ('35', 'egg noodles with vegetables', 3.00, 'menu/青菜鸡蛋面.jpg', '2018-08-30', 1, '青菜鸡蛋面', '3');
...
INSERT INTO `menu` VALUES ('38', 'an earthenware pot chicken soup', 8.00, 'menu/砂锅鸡汤.jpg', '2018-08-12', 0, '砂锅鸡汤', '6');
INSERT INTO `menu` VALUES ('39', 'charcoal burning milk tea', 4.00, 'menu/炭烧奶茶.jpg', '2018-08-11', 1, '炭烧奶茶', '4');
INSERT INTO `menu` VALUES ('4', 'fried rice-flour noodles ', 4.00, 'menu/炒米粉.jpg', '2018-08-23', 0, '炒米粉', '3');
INSERT INTO `menu` VALUES ('40', 'tanghe powder', 4.00, 'menu/汤河粉.jpg', '2018-08-28', 0, '汤河粉', '3');
INSERT INTO `menu` VALUES ('41', 'sweet and sour spare ribs', 11.00, 'menu/糖醋排骨.jpg', '2018-08-08', 1, '糖醋排骨', '1');
INSERT INTO `menu` VALUES ('42', 'sweet and spicy corn spareribs', 12.00, 'menu/甜辣玉米排骨.jpg', '2018-08-02', 0, '甜辣玉米排骨', '1');
INSERT INTO `menu` VALUES ('43', 'black chicken and chestnut soup', 13.00, 'menu/乌鸡栗子滋补汤.jpg', '2018-08-09', 1, '乌鸡栗子滋补汤', '6');
INSERT INTO `menu` VALUES ('44', 'cray', 9.00, 'menu/小龙虾.jpg', '2018-08-24', 0, '小龙虾', '1');
INSERT INTO `menu` VALUES ('45', 'steamed spareribs with rice flour ', 7.00, 'menu/小笼粉蒸排骨.jpg', '2018-08-14', 1, '小笼粉蒸排骨', '1');
...
INSERT INTO `menu` VALUES ('48', 'shredded pork with garlic sauce', 7.00, 'menu/鱼香肉丝.jpg', '2018-08-31', 0, '鱼香肉丝', '1');
INSERT INTO `menu` VALUES ('49', 'corn and spareribs soup', 5.00, 'menu/玉米排骨汤.jpg', '2018-08-17', 1, '玉米排骨汤', '6');
INSERT INTO `menu` VALUES ('5', 'white sliced chicken with scallion flavor', 5.00, 'menu/葱香白切鸡.jpg', '2018-08-18', 1, '葱香白切鸡', '1');
INSERT INTO `menu` VALUES ('50', 'wonton noodles ', 3.00, 'menu/云吞面.jpg', '2018-08-13', 0, '云吞面', '3');
INSERT INTO `menu` VALUES ('51', 'pork stomach and chicken ', 25.00, 'menu/猪肚鸡.jpg', '2018-08-04', 1, '猪肚鸡', '6');
...
INSERT INTO `menu` VALUES ('8', 'scrambled egg with tomato', 3.50, 'menu/番茄炒蛋.jpg', '2018-08-03', 0, '番茄炒蛋', '1');
INSERT INTO `menu` VALUES ('9', 'sliced tomato noodles', 4.00, 'menu/番茄刀削面.jpg', '2018-08-19', 1, '番茄刀削面', '3');
