...
-- Records of about
-- ----------------------------
INSERT INTO `about` VALUES ('1', 'Online_ordering', 'Guangdong Ocean University', 'Wenjie Shi', '123456789', '/about/aboutDesc.txt');
...
INSERT INTO `category` VALUES ('1', 'Staple');
INSERT INTO `category` VALUES ('2', 'Combo');
INSERT INTO `category` VALUES ('3', 'Noodles');
INSERT INTO `category` VALUES ('4', 'Berages');
INSERT INTO `category` VALUES ('5', 'Refreshments');
INSERT INTO `category` VALUES ('6', 'Stew');
...
INSERT INTO `comment` VALUES ('160104c2-a124-4465-8d2c-7c1f88a17896', 'aaa', 'content1', '2018-09-06 19:23:06', '16');
INSERT INTO `comment` VALUES ('1d679efd-96a2-4178-9a65-755b8e18e4d4', 'aaa', 'content2', '2018-09-06 20:35:31', '13');
INSERT INTO `comment` VALUES ('1d9e2f7e-23f7-45ee-b355-3636075de1be', 'aaa', 'content3', '2018-09-06 20:34:26', '13');
INSERT INTO `comment` VALUES ('4a21db6a-14b5-44db-96ce-6b9a3b1ac3a7', 'bbb', 'content4', '2018-09-06 20:05:28', '16');
INSERT INTO `comment` VALUES ('50b717fd-9f97-4256-9a2f-f3a3c58aa61f', 'aaa', 'content5', '2018-09-06 20:14:44', '21');
INSERT INTO `comment` VALUES ('6e331721-eeed-4fbf-b9a3-306f9cab99e7', 'aaa', 'content6', '2018-09-06 20:35:13', '13');
INSERT INTO `comment` VALUES ('72c7ea42-0eed-431d-9f1f-8601eb8657bc', 'aaa', 'content7', '2018-09-06 20:34:23', '13');
INSERT INTO `comment` VALUES ('7535d6bd-3013-4f0e-84b5-0b0fbe7049ea', 'aaa', 'content8', '2018-10-30 10:28:05', '2');
INSERT INTO `comment` VALUES ('7d52f36d-3bc7-4376-9851-ffb9a14d46a5', 'aaa', 'content9', '2018-09-06 20:37:07', '13');
INSERT INTO `comment` VALUES ('85bf2a10-5fcd-4326-a409-bb819f0d7c2f', 'aaa', 'content10', '2018-09-06 19:22:56', '16');
INSERT INTO `comment` VALUES ('8ff90f2b-ee0b-4df5-b381-75de3ba3431f', 'aaa', 'content11', '2018-09-06 20:35:13', '13');
INSERT INTO `comment` VALUES ('acf5f694-f624-4e0b-8005-a0b7d791f80d', 'aaa', 'content12', '2018-09-06 20:34:26', '13');
INSERT INTO `comment` VALUES ('b43a763a-b061-47a5-8359-babe7aef96a1', 'aaa', 'content13', '2018-09-06 20:34:23', '13');
INSERT INTO `comment` VALUES ('cd7bd1ba-d37a-42c4-a0c9-4f2a15cfe503', 'aaa', 'content14', '2018-09-06 19:23:01', '16');
INSERT INTO `comment` VALUES ('fbb7165d-952f-45ee-8f05-69985e9dfa31', 'aaa', 'content15', '2018-09-06 19:21:30', '16');
INSERT INTO `comment` VALUES ('ffc250a2-5c21-4361-a30b-3ece0bdf5426', 'aaa', 'content16', '2018-09-06 20:35:31', '13');
...
-- Records of menu
-- ----------------------------
INSERT INTO `menu` VALUES ('1', 'stir-fried cabbage', 2.00, 'menu/白菜.jpg', '2018-08-16', 1, 'baicai', '1');
INSERT INTO `menu` VALUES ('10', 'saute diced ', 6.00, 'menu/宫爆鸡丁.jpg', '2018-08-30', 0, 'gongbaojiding', '1');
INSERT INTO `menu` VALUES ('11', 'fruit', 4.00, 'menu/果蔬沙拉.jpg', '2018-08-06', 1, 'guoshushala', '5');
INSERT INTO `menu` VALUES ('12', 'seaweed ribs ', 10.00, 'menu/海带排骨冬瓜汤.jpg', '2018-08-05', 0, 'haidaidongguapaigutang', '6');
INSERT INTO `menu` VALUES ('13', 'pepper steak', 9.00, 'menu/黑椒牛扒.jpg', '2018-08-12', 1, 'heijiaoniupa', '1');
INSERT INTO `menu` VALUES ('14', 'red bull ', 2.00, 'menu/红牛.jpg', '2018-09-09', 0, 'red bull', '4');
INSERT INTO `menu` VALUES ('15', 'braised meatball', 3.50, 'menu/红烧丸子饭.jpg', '2018-08-01', 0, 'braised meatball', '2');
INSERT INTO `menu` VALUES ('16', 'carved drunk ', 3.50, 'menu/花雕醉鸡卷.jpg', '2018-08-28', 0, '花雕醉鸡卷', '5');
INSERT INTO `menu` VALUES ('17', 'plain stir-fried ', 3.00, 'menu/家常素炒面.jpg', '2018-08-02', 1, '家常素炒面', '3');
INSERT INTO `menu` VALUES ('18', 'fried egg', 1.00, 'menu/煎鸡蛋.jpg', '2018-08-09', 0, '煎鸡蛋', '5');
INSERT INTO `menu` VALUES ('19', 'chicken', 3.00, 'menu/烤鸡排套餐.jpg', '2018-08-24', 1, '烤鸡排套餐', '2');
INSERT INTO `menu` VALUES ('2', 'noodles', 3.00, 'menu/拌面.jpg', '2018-08-27', 0, '拌面', '3');
INSERT INTO `menu` VALUES ('20', 'cola', 1.50, 'menu/可乐.jpg', '2018-08-14', 0, '可乐', '4');
INSERT INTO `menu` VALUES ('21', 'chicken', 3.50, 'menu/口水鸡套餐.jpg', '2018-08-22', 1, '口水鸡套餐', '2');
INSERT INTO `menu` VALUES ('22', 'cooker soup', 5.00, 'menu/老火靓汤.jpg', '2018-08-21', 0, '老火靓汤', '6');
INSERT INTO `menu` VALUES ('23', 'brine ', 5.00, 'menu/卤水双拼套餐.jpg', '2018-08-31', 1, '卤水双拼套餐', '2');
INSERT INTO `menu` VALUES ('24', 'Mapo beancurd ', 5.00, 'menu/麻婆豆腐.jpg', '2018-08-17', 0, '麻婆豆腐', '1');
INSERT INTO `menu` VALUES ('25', 'roast pork', 6.00, 'menu/美味叉烧.jpg', '2018-08-13', 1, '美味叉烧', '1');
INSERT INTO `menu` VALUES ('26', 'delicious', 4.00, 'menu/美味鸡翅.jpg', '2018-08-04', 0, '美味鸡翅', '1');
INSERT INTO `menu` VALUES ('27', 'rice', 1.50, 'menu/米饭.jpg', '2018-08-26', 1, '米饭', '5');
INSERT INTO `menu` VALUES ('28', 'sirloin combo', 3.00, 'menu/秘制牛腩营养套餐.jpg', '2018-08-25', 0, '秘制牛腩营养套餐', '2');
INSERT INTO `menu` VALUES ('29', 'chicken skewers', 4.00, 'menu/蜜汁鸡肉串.jpg', '2018-08-10', 1, '蜜汁鸡肉串', '5');
INSERT INTO `menu` VALUES ('3', 'fried rice noodles ', 4.00, 'menu/炒河粉.jpg', '2018-08-29', 1, '炒河粉', '3');
INSERT INTO `menu` VALUES ('30', 'buckets of chicken', 4.50, 'menu/木桶鸡.jpg', '2018-08-01', 0, '木桶鸡', '1');
INSERT INTO `menu` VALUES ('31', 'lemon C', 2.00, 'menu/柠檬C.jpg', '2018-08-15', 1, '柠檬C', '4');
INSERT INTO `menu` VALUES ('32', 'lemon spice ', 2.50, 'menu/柠香手抓大鸡排.jpg', '2018-08-20', 0, '柠香手抓大鸡排', '5');
INSERT INTO `menu` VALUES ('33', 'steak meal', 4.00, 'menu/牛扒套餐.jpg', '2018-08-03', 1, '牛扒套餐', '2');
INSERT INTO `menu` VALUES ('34', 'steak', 10.00, 'menu/牛排.jpg', '2018-08-19', 0, '牛排', '1');
INSERT INTO `menu` VALUES ('35', 'egg noodles ', 3.00, 'menu/青菜鸡蛋面.jpg', '2018-08-30', 1, '青菜鸡蛋面', '3');
INSERT INTO `menu` VALUES ('36', 'bitter gourd ', 3.00, 'menu/青瓜.jpg', '2018-08-06', 0, '青瓜', '1');
INSERT INTO `menu` VALUES ('37', 'stir-fried shrimp', 10.00, 'menu/清炒青虾.jpg', '2018-08-05', 1, '清炒青虾', '1');
INSERT INTO `menu` VALUES ('38', 'an earthenware ', 8.00, 'menu/砂锅鸡汤.jpg', '2018-08-12', 0, '砂锅鸡汤', '6');
INSERT INTO `menu` VALUES ('39', 'charcoal ', 4.00, 'menu/炭烧奶茶.jpg', '2018-08-11', 1, '炭烧奶茶', '4');
INSERT INTO `menu` VALUES ('4', 'fried  ', 4.00, 'menu/炒米粉.jpg', '2018-08-23', 0, '炒米粉', '3');
INSERT INTO `menu` VALUES ('40', 'tanghe powder', 4.00, 'menu/汤河粉.jpg', '2018-08-28', 0, '汤河粉', '3');
INSERT INTO `menu` VALUES ('41', 'sweet ', 11.00, 'menu/糖醋排骨.jpg', '2018-08-08', 1, '糖醋排骨', '1');
INSERT INTO `menu` VALUES ('42', 'sweet ', 12.00, 'menu/甜辣玉米排骨.jpg', '2018-08-02', 0, '甜辣玉米排骨', '1');
INSERT INTO `menu` VALUES ('43', 'black chicken ', 13.00, 'menu/乌鸡栗子滋补汤.jpg', '2018-08-09', 1, '乌鸡栗子滋补汤', '6');
INSERT INTO `menu` VALUES ('44', 'cray', 9.00, 'menu/小龙虾.jpg', '2018-08-24', 0, '小龙虾', '1');
INSERT INTO `menu` VALUES ('45', 'steamed spareribs ', 7.00, 'menu/小笼粉蒸排骨.jpg', '2018-08-14', 1, '小笼粉蒸排骨', '1');
INSERT INTO `menu` VALUES ('46', 'spirit', 1.50, 'menu/雪碧.jpg', '2018-08-22', 0, '雪碧', '4');
INSERT INTO `menu` VALUES ('47', 'Yangzhou fried rice', 4.00, 'menu/扬州炒饭.jpg', '2018-08-21', 1, '扬州炒饭', '2');
INSERT INTO `menu` VALUES ('48', 'shredded pork', 7.00, 'menu/鱼香肉丝.jpg', '2018-08-31', 0, '鱼香肉丝', '1');
INSERT INTO `menu` VALUES ('49', 'spareribs soup', 5.00, 'menu/玉米排骨汤.jpg', '2018-08-17', 1, '玉米排骨汤', '6');
INSERT INTO `menu` VALUES ('5', 'chicken', 5.00, 'menu/葱香白切鸡.jpg', '2018-08-18', 1, '葱香白切鸡', '1');
INSERT INTO `menu` VALUES ('50', 'wonton noodles ', 3.00, 'menu/云吞面.jpg', '2018-08-13', 0, '云吞面', '3');
INSERT INTO `menu` VALUES ('51', 'pork stomach ', 25.00, 'menu/猪肚鸡.jpg', '2018-08-04', 1, '猪肚鸡', '6');
INSERT INTO `menu` VALUES ('6', 'sausage', 3.00, 'menu/脆骨肠.jpg', '2018-08-07', 0, '脆骨肠', '5');
INSERT INTO `menu` VALUES ('7', 'steamed crab ', 10.00, 'menu/大闸蟹.jpg', '2018-08-20', 1, '大闸蟹', '1');
INSERT INTO `menu` VALUES ('8', 'scrambled egg ', 3.50, 'menu/番茄炒蛋.jpg', '2018-08-03', 0, '番茄炒蛋', '1');
INSERT INTO `menu` VALUES ('9', 'sliced tomatonoodles', 4.00, 'menu/番茄刀削面.jpg', '2018-08-19', 1, '番茄刀削面', '3');
